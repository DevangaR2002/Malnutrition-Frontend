    ...
    <ProtectedRoute>
      <main className="container-page">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              Malnutrition Risk Assessment & Monitoring Overview
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="card bg-slate-800 text-white rounded-xl shadow-lg border-0 p-5 flex items-center justify-between col-span-1 md:col-span-1">
          ...
          <div className="card bg-slate-800 text-white rounded-xl shadow-lg border-0 p-5 flex items-center justify-between col-span-1 md:col-span-1">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-2xl font-bold">{lowCases}</div>
                <div className="text-sm text-slate-400">Normal / Low Risk</div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-end gap-2">
                  <div className="text-2xl font-bold">{moderateCases}</div>
                </div>
          ...
          <div className="card bg-slate-800 text-white rounded-xl shadow-lg border-0 p-5 flex items-center justify-between col-span-1 md:col-span-1">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-end gap-2">
                  <div className="text-2xl font-bold">{severeCases}</div>
                  <div className="text-xs text-rose-400 font-semibold pb-1">
                    {severePct}%
                  </div>
                </div>
          ...
          <div className="card lg:col-span-2 flex flex-col p-6 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
            <div className="mb-4">
              ...
              <p className="text-xs text-slate-500">
                Total assessments flagged as Moderate or Severe risk over time.
              </p>
            </div>
